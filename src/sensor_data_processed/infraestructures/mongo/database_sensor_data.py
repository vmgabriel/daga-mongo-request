...
## Mongo
from sensor_data_processed.infraestructures.mongo.actions.create import Create_SensorData as Create_Mongo
from sensor_data_processed.infraestructures.mongo.actions.create_massive import CreateMassive_SensorData as CreateMassive_Mongo
